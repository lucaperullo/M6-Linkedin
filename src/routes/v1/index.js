...
router.use("/users", userRoutes); //verifyToken is checking if the token is the one that we need (for example  - password : "12345" ==> will generate a random token that will be valid only for the id we provided by searching for username and password is present in our database )
